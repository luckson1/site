    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
      <div className="card w-full glass shadow-accent shadow-lg ">
        <figure className="relative w-full h-[300px]">
          <Image src="https://res.cloudinary.com/dhciks96e/image/upload/v1678480548/dashboard_cwkx7m.png" fill alt="web-screenshot" />
        </figure>
        <div className="card-body">
          <h2 className="card-title">Ecommerce Dashboard</h2>
          <p>A responsive e-commerce and finance dashboard</p>
          <div className="card-actions justify-end">
            <Link href="https://dashboarding.netlify.app/">
              {" "}
      ...
      <div className="card w-full glass shadow-accent shadow-lg ">
        <figure className="relative w-full h-[300px]">
          <Image src="https://res.cloudinary.com/dhciks96e/image/upload/v1678480552/task_whbfpx.png" fill alt="web-screenshot" />
        </figure>
        <div className="card-body">
          ...
          <div className="card-actions justify-end">
          <Link href="https://techivity.netlify.app">
              {" "}
              <button className="btn btn-primary">Visit Site</button>
            </Link>
          </div>
      ...
      <div className="card w-full glass shadow-accent shadow-lg ">
        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-end">
          <Link href="https://jenga.vercel.app/">
              {" "}
              <button className="btn btn-primary">Visit Site</button>
            </Link>
          </div>
