    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
      ...
      <div className="card w-full glass shadow-accent shadow-lg ">
        ...
        <div className="card-body">
          ...
          <p>
            Sasha is student writing assistant. It uses AI to help in idea
            generation as well as speed the research process, saving students
            time taken to complete their assignments
          </p>
          <div className="card-actions justify-end">
            <Link href={"https://www.smartsasha.com/"} target="_blank">
              {" "}
              <button className="btn btn-primary">Visit Site</button>
            </Link>
          </div>
